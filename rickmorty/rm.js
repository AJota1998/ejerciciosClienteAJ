...
function inicio() {
  ...
  document.getElementById("cargar_personajes_xml").onclick = cargar_personajes_xml;
  document.getElementById("cargar_personajes_fetch").onclick = cargar_personajes_fetch;
  ...
  for (let i = min; i <= max; i++) {
    ...
    xhr.onreadystatechange = function () {
      if (
        ...
        document.getElementById("resultados").innerHTML += `Personaje ${data.name} cargado <br>`;
        console.log(data);
      ...
      for (const episodio of episodios) {
        ...
        xhr.onreadystatechange = function () {
          if (
            ...
            let data = JSON.parse(xhr.responseText);
            document.getElementById("resultados").innerHTML += `Episodio ${data.name} cargado <br>`;
            console.log(data);
