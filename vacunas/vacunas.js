...
function modificar_datos() {
	...
	let comunidad_json = {
		...
		porcentajePoblacionAdministradas: document.getElementById("por_poblacion_admin").value,
		porcentajePoblacionCompletas: document.getElementById("por_poblacion_completa").value,
	};
