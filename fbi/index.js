...
function start() {
	...
	document.getElementById("btn_load").addEventListener("click", get_criminals_from_fbi);
	
	document.getElementById("btn_clear").addEventListener("click", clear);
	
	document.getElementById("btn_get_criminals_xml").addEventListener("click", get_criminals_from_db_xml);
	
    document.getElementById("btn_get_criminals_fetch").addEventListener("click", get_criminals_from_db_fetch);
